...
As a first approximation towards understanding sound, imagine a large explosion at the moment the tree strikes the ground, except that instead of an outwardly expanding sphere of fire, there is an outwardly expanding sphere where air particles are more tightly bunched together. This momentary compression of air particles constitutes a change in \emph{air pressure} in that location.
...
(This figure is an idealized version. In reality, the telegraph signal was distorted by the time it was received and so did not look quite so clean, but this serves as an idealized representation of the signal being sent and received. We will discuss distortions later on.)
...
As such, tones are distinguished by their frequency; higher-frequency sound waves have a higher pitch, a fact also familiar to those familiar with music.
