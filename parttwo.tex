...
As it happens, the mathematics behind combining these sinusoidal signals is quite important for telecommunication technology, and it turns out that combining signals is very simple, amounting to pointwise addition.
...
Before we build a telephone, let's take stock of what electrical components we have at our disposal and formalize our electrical circuit diagrams a bit. We have already met the \emph{relay}, the \{power source} (or battery).
