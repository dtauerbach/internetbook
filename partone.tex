...
That's quite a lot of information that can be sent with 7 characters! As a point of comparison, there are only 51339 English words that are 7 letters or less. This should reinforce the intuition that the system of coding phrases is somehow more efficient than just writing English.

Can we make this notion of efficiency precise?

IAMHERE


Now suppose you were designing a system like this where short sets of letters corresponded to important phrases, and your goal was to make the system as efficient as possible.


This explosion in the number of possible messages that can be sent with such a small number of letters is a remarkable fact. It underlies why human beings will never run out of 140-character tweets, and why even 20-character passwords are thought to be strong enough that even the world's most powerful governments cannot break them.
