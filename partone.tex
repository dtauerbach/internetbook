...
Try translating: what English word does this represent?
...
Despite a lack of theoretical understanding of the fundamental principles that enabled electrical telegraphy to function, early electrical engineers forged ahead in improving the telegraph. It didn't work perfectly though, and so a lot of energy was spent trying to get telegraphs to be more reliable, to function over long distances, and to be able to cross harsh terrain.
...
For telegraphs to function at scale, more sophisticated cabling was needed. Fortunately, a tree sap called \emph{gutta-percha} was discovered in 1843 and quickly became a household name in the Victorian world. Known for producing a naturally rigid latex, gutta-percha became the mid to late 19th century's equivalent of plastic today, and among its myriad uses was as an insulator surrounding raw copper telegraph wires. The gutta-percha in turn was often wrapped in rubber, and then an outer layer of iron or steel, creating a cable whose cross section looked something like this:
