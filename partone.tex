...
That's quite a lot of information that can be sent with 7 characters! As a point of comparison, there are only 51339 English words that are 7 letters or less. This should reinforce the intuition that the system of coding phrases is more efficient than just writing English.

\subsection{Entropy}

In order to make precise the notion that the system of codes is more efficient than plain English, we need to introduce the idea of \emph{entropy}, which is defined to be a measure of unpredictability of information content. [CITE wiki?]
